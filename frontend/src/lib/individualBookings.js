...
export function bookingStatusToUi(status) {
  ...
  if (s === 'pending_review') {
    return { label: 'Pending review', variant: 'slate', tone: 'bg-[#FAFAFA] text-[#A5B4FC] ring-1 ring-[#E0E7FF]' }
  }
  if (s === 'confirmed') {
    return { label: 'Confirmed', variant: 'sky', tone: 'bg-[#E0E7FF]/40 text-[#4F46E5] ring-1 ring-[#E0E7FF]' }
  }
  if (s === 'assigned') {
    return { label: 'Workers assigned', variant: 'sky', tone: 'bg-[#D1FAE5] text-[#059669] ring-1 ring-[#A7F3D0]' }
  }
  if (s === 'in_progress') {
  ...
  if (s === 'accepted') {
    return { label: 'Worker accepted', variant: 'sky', tone: 'bg-[#E0E7FF]/40 text-[#4F46E5] ring-1 ring-[#E0E7FF]' }
  }
  if (s === 'cancelled') {
    return { label: 'Cancelled', variant: 'rose', tone: 'bg-rose-50 text-rose-600 ring-1 ring-rose-200' }
  }
  if (s === 'completed') {
    return { label: 'Completed', variant: 'slate', tone: 'bg-slate-50 text-slate-500 ring-1 ring-slate-200' }
  }
...
export function bookingWorkflowStepIndex(status) {
  ...
  if (s === 'on_site' || s === 'in_progress') return 3
