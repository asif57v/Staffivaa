  ...
  return (
    <motion.button
      ...
      className={`flex w-full min-w-0 flex-col rounded-2xl border px-3.5 py-3 text-left transition active:scale-[0.98] ${
        active
          ? 'border-brand/45 bg-linear-to-br from-brand/12 via-white to-sky-50/40 shadow-[0_12px_28px_-18px_rgba(125,207,245,0.45)] ring-2 ring-brand/20'
    ...
    >
      ...
      <p className="sr-only">Topic: {topic.label}</p>
    </motion.button>
  )
}
