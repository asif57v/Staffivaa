/** Dummy marketing copy & structured content for Staffivaa landing */

export const SITE = {
  name: 'Staffivaa',
  tagline: 'India’s trusted on-demand construction workforce',
  url: 'https://staffivaa.com',
  contactEmail: 'hello@staffivaa.com',
...
export const comparisonRows = [
  {
    ...
    staffivaa: 'Search, filter, and book in minutes',
  },
  {
    aspect: 'Verification',
    traditional: 'Informal references only',
    staffivaa: 'Aadhaar-linked profiles & skill tags',
  },
  {
    aspect: 'Pricing',
    traditional: 'Negotiated case-by-case',
    staffivaa: 'Transparent slabs & estimates upfront',
  },
  {
    aspect: 'Reliability',
    traditional: 'High variance, hard to replace',
    staffivaa: 'Ratings, backups & priority support',
  },
  {
    aspect: 'Payments',
    traditional: 'Mostly cash, limited records',
    staffivaa: 'UPI, cards & secure escrow-style flow',
  },
]
...
export const testimonials = [
  {
    ...
    quote:
      'We needed masons and helpers for a 10-day renovation. Booking on Staffivaa took minutes and the crew showed up on time—something that rarely happened with our old contacts.',
    rating: 5,
