...
export function AppMediaCard({
  ...
  return (
    <Wrapper
      ...
      onClick={onClick}
      className={`w-full overflow-hidden rounded-2xl border border-[#e2e8f0] bg-white text-left shadow-[0_8px_28px_-14px_rgba(15,23,42,0.12)] ring-1 ring-black/[0.02] transition hover:border-[#0f172a] hover:shadow-[0_12px_36px_-16px_rgba(15,23,42,0.12)] ${interactive ? 'active:scale-[0.99]' : ''} ${className}`}
    >
